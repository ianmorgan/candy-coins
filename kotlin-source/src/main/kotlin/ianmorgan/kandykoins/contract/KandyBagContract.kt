...
class KandyBagContract : Contract {
    companion object {
        @JvmStatic
        val KANDY_CONTRACT_ID = "ianmorgan.kandykoins.contract.KandyBagContract"
    }
    ...
    override fun verify(tx: LedgerTransaction) {
        ...
        when (command.value) {
            is Commands.Give -> requireThat {
                ...
                val bag = tx.outputStates.single() as KandyBagState
            ...
            is Commands.Eat -> {
                ...
                val bag = tx.inputStates.single() as KandyBagState
                ...
                if (bag.hasEnough(cmd.chocolates,cmd.gobstoppers,cmd.jellybeans)){
                    ...
                    if (updatedBag.isEmpty()){
                        ...
                        val out = tx.outputStates.single() as KandyBagState
