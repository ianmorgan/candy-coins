...
import ianmorgan.candycoins.contract.IOUContract
...
class IOUSettleFlowTests {
    ...
    @Before
    fun setup() {
        mockNetwork = MockNetwork(listOf("ianmorgan.candycoins", "net.corda.finance.contracts.asset", CashSchemaV1::class.packageName),
