...
import ianmorgan.candycoins.DUMMY
 ...
 * As with the [IOUStateTests] uncomment each unit test and run them one at teacher time. Use the body of the tests and the
